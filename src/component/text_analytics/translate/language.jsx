// languages calling this component from the document translation componenent 
const languages = [
    ...
    { code: 'tlh-Piqd', name: 'Klingon' },
    { code: 'gom', name: 'Konkani' },
    { code: 'ko', name: 'Korean' },
    { code: 'ku', name: 'Kurdish' },
    { code: 'kmr', name: 'Kurdish (Central)' },
    { code: 'ku', name: 'Kurdish (Northern)' },
